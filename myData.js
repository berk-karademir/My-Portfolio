export const languageData = {
  ...
  tr: {
    ...
    profile: {
      ...
      aboutMe: [
        "Hakkımda",
        "Üniversiteden 2020'de mazun oldum, yaklaşık 3 yıl perakende sektöründeki bir zincir mağazada çalıştım. Yazılıma Eylül 2024'te full-stack web developer eğitimiyle başladım. İş tecrübesi ve dahil olacağım bir sonraki proje için sabırsızlanıyorum.",
      ],
    },
    projects: [
      { header: "Projeler" },
